...
def main():
    ...
    plt.title('BERT Dataset (128-dim) with 300,000 Entries, Retrieving Top-50 (0.5%)')
    plt.ylim([0, 1])
    plt.legend()
    ...
    plt.xlabel('Num. of Signals')
    plt.ylabel('Mean Average Precision')
    plt.title('BERT Dataset (128-dim) with 300,000 Entries, Retrieving Top-100 (1%)')
    plt.ylim([0, 1])
    plt.legend()
    ...
    plt.xlabel('Num. of Signals')
    plt.ylabel('Mean Average Precision')
    plt.title('BERT Dataset (128-dim) with 300,000 Entries, Retrieving Top-200 (2%)')
    plt.ylim([0, 1])
    plt.legend()

    plt.savefig('./figures/experiment46.png', bbox_inches='tight')
