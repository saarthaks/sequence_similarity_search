...
def main():
    ...
    plt.title('SIFT10M Dataset (128-dim) with 300,000 Entries, Retrieving Top-50 (0.016%)')
    plt.ylim([0, 1])
    plt.legend()
    ...
    plt.xlabel('Num. of Signals')
    plt.ylabel('Mean Average Precision')
    plt.title('SIFT10M Dataset (128-dim) with 300,000 Entries, Retrieving Top-100 (0.033%)')
    plt.ylim([0, 1])
    plt.legend()
    ...
    plt.xlabel('Num. of Signals')
    plt.ylabel('Mean Average Precision')
    plt.title('SIFT10M Dataset (128-dim) with 300,000 Entries, Retrieving Top-200 (0.066%)')
    plt.ylim([0, 1])
    plt.legend()

    plt.savefig('./figures/experiment48.png', bbox_inches='tight')
