...
def main():
    ...
    file_db = './datasets/SIFT10Mfeatures.mat'
    data_source = SIFTDataset(file_db, n)
    ...
    plt.title('SIFT10M Dataset (128-dim) with 10000 Entries, Retrieving Top-50 (0.5%)')
    plt.ylim([0, 1])
    plt.legend()
    ...
    plt.xlabel('Num. of Signals')
    plt.ylabel('Mean Average Precision')
    plt.title('SIFT10M Dataset (128-dim) with 10000 Entries, Retrieving Top-100 (1%)')
    plt.ylim([0, 1])
    plt.legend()
    ...
    plt.xlabel('Num. of Signals')
    plt.ylabel('Mean Average Precision')
    plt.title('SIFT10M Dataset (128-dim) with 10000 Entries, Retrieving Top-200 (2%)')
    plt.ylim([0, 1])
    plt.legend()

    plt.savefig('./figures/experiment29.png', bbox_inches='tight')
